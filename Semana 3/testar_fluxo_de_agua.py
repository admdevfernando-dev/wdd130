...
def test_calc_altura_coluna_agua():
    assert calc_altura_coluna_agua(0.0, 0.0) == approx(0.0, abs=0.001)
    assert calc_altura_coluna_agua(0.0, 10.0) == approx(7.5, abs=0.001)
    assert calc_altura_coluna_agua(25.0, 0.0) == approx(25.0, abs=0.001)
    assert calc_altura_coluna_agua(48.3, 12.8) == approx(57.9, abs=0.001)
